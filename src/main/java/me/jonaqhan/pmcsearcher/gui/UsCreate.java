...
public class UsCreate {

	public ItemStack createItem(UsData data, String[] colors) {
	...
	public Inventory createGUI(Player p, UsData data) {
	...
	public List<String> getLore(UsData data, String[] colors) {
